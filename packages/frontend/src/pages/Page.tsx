...
function Page({ children, className }: { children: ReactNode, className?: string }) {
    return (
        <div className="flex flex-col min-h-screen bg-gray-50 relative shadow-white-400/100">
            <header className="bg-white relative shadow flex items-center justify-between px-6 py-4">
            ...
            <footer className="bg-gray-50 relative shadow-white-400/100 shadow  z-20 text-sm flex flex-col md:flex-row justify-between  px-6 py-6 justify-center">
